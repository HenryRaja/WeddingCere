...
function HelloSection({ guestName }) {
  const finalSubtitle = guestName ? 'August 24th, 2020 Palayamkottai' : 'August 24th, 2020 Palayamkottai';
          ...
          <div className="couple-wrap">
            <div className="couple-half">
              ...
              <div className="desc-groom">
                <h3 className="main-font">Preetha</h3>
            ...
            <div className="couple-half">
              ...
              <div className="desc-bride">
                <h3 className="main-font">Henry</h3>
